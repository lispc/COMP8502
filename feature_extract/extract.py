...
NAMES = ["MALWARE"] + ALL_PERMISSIONS + map(lambda x: x[1:].upper(), FILE_EXTENSIONS) + ["DEXLEN", "PACKLEN", "FILENO", "ACTNO", "SERVICENO", "PROVIDERNO", "CRYPTO", "TELEPHONY", "NET", "DYN_CODE", "NATIVE_CODE", "REFLECTION", "CLASSES", "METHODS", "FIELDS"]
